...
Native baseline coverage: 20/36 pins; fully checked problems: 8/15. Reported fresh native processes: 60.
...
| Cslib.SKI.parallelReduction_diamond | 407 → 407 | 3/4 | INCOMPLETE | 1,643,029–1,657,055 | — |
...
| Binius.BinaryBasefold.fold_advances_evaluation_poly | 1906 → 1906 | 1/3 | INCOMPLETE | 47,012,062–47,012,062 | — |
| interleaved_affine_gaps_imply_tensor_gaps | 1353 → 1353 | 1/3 | INCOMPLETE | 9,976,769–9,976,769 | — |
| putnam_1964_a4 | 1769 → 1769 | 0/3 | INCOMPLETE | unavailable | — |
| putnam_1964_b2 | 1754 → 1754 | 0/2 | INCOMPLETE | unavailable | — |
| putnam_1995_a3 | 4085 → 4085 | 0/3 | INCOMPLETE | unavailable | — |
...
- `Cslib.SKI.parallelReduction_diamond` / `v4.30.0`: project_commit_mismatch
- `Binius.BinaryBasefold.fiberwise_dist_lt_imp_dist_lt_unique_decoding_radius` / `v4.30.0`: project_commit_mismatch
...
- `Binius.BinaryBasefold.fold_advances_evaluation_poly` / `v4.30.0`: project_commit_mismatch
- `Binius.BinaryBasefold.fold_advances_evaluation_poly` / `v4.29.0`: project_commit_mismatch
- `interleaved_affine_gaps_imply_tensor_gaps` / `v4.30.0`: project_commit_mismatch
- `interleaved_affine_gaps_imply_tensor_gaps` / `v4.29.0`: project_commit_mismatch
- `putnam_1964_a4` / `v4.25.0`: [Errno 2] No such file or directory: '/home/barberb/.local/state/ipfs_accelerate_py/vericodegen-2026-lra/track1-lake/putnam_lake/v4.25.0'
...
- `putnam_1964_b2` / `v4.25.0`: [Errno 2] No such file or directory: '/home/barberb/.local/state/ipfs_accelerate_py/vericodegen-2026-lra/track1-lake/putnam_lake/v4.25.0'
- `putnam_1964_b2` / `v4.26.0`: putnam_compiled_import_missing: Mathlib
- `putnam_1995_a3` / `v4.25.0`: [Errno 2] No such file or directory: '/home/barberb/.local/state/ipfs_accelerate_py/vericodegen-2026-lra/track1-lake/putnam_lake/v4.25.0'
